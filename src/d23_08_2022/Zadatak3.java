...
//		konstruktor sa parametrima, postavljaju ce tip ringle i jacina grejaca
//		(jacina atribut je po defaultu 0)
//		getter za jacinu
//		setteri ne postoje!!
...
//		100 / maksimalan broj pojacavanja * jacina * jacina grejaca * vremenski
//		period koliko vec ringla radi 
//		metoda prima broj sati kao parametar tj. vremenski period koliko ringla vec radi
//		metodu koja stampa podatke u formatu:
//			Ringla je ukljucena ili iskljucena (iskoristite metodu koja vraca tu 
//					informaciju da biste odstampali poruku)
...
//		Grejac: jacina grejaca kW
		...
		Ringla doleD = new Ringla("eskpres", 2);
		ElektricniSporet gorenje = new ElektricniSporet("Gorenje", 5, 3, goreL, goreD, doleL, doleD);
		goreD.pojacajRinglu();
		goreD.pojacajRinglu();
		goreD.pojacajRinglu();
		goreL.pojacajRinglu();
		...
		doleL.pojacajRinglu();
		gorenje.print();
		double potrosnja = gorenje.ukupnaPotrosnja(1, 3, 5, 10);
