...
//		kojoj je potrebno izvrsiti konverziju (RSD/USD/RUB) a vraca 
//		konvertovanu vrednost. U glavnom programu pozvati funkciju za 
//		neki od primera.
...
//		1 EUR = 62.98 RUB
		...
		System.out.print("Unesite koliko eura zelite da zamenite: ");
		double euro = s.nextDouble();
		System.out.print("Unesite valutu u koju zelite da promenite: ");
		String valuta = s.next();
		double konvertor = menjacnica(euro, valuta);
		System.out.println("Vas iznos je: " + konvertor);

	}

	public static double menjacnica(double euro, String valuta) {
