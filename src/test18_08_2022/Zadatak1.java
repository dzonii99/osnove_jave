...
//		Notifikacija: Nova verzija aplikacije je dostupna za instalaciju.
		...
		System.out.print("Unesite major broj instaliranje verzije: ");
		int major = s.nextInt();
		System.out.print("Unesite minor broj instaliranje verzije: ");
		int minor = s.nextInt();
		System.out.print("Unesite major broj najnovije verzije: ");
		int majorNew = s.nextInt();
		System.out.print("Unesite major broj najnovije verzije: ");
		int minorNew = s.nextInt();
		System.out.println("Na racunaru je instalirano: " + major + "." + minor);
		System.out.println("Najnovija verzija je: " + majorNew + "." + minorNew);
		if (majorNew > major || minorNew > minor) {
			System.out.println("Nova verzija aplikacije je dostupna za" 
					+ " instalaciju.");
