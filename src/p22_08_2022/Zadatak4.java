...
//			rezim koji moze da bude - mini player , bioskopski rezim , preko 
//			celog ekrana
//			jacinu zvuka
//			trenutno vreme videa u reprodukciji
//			gettere za sve atribute
//			samo difoltni konstuktor, i njemu se svuk postavlja na 75 i kvalitet po
//			difoltu na 144 kao i rezim na mini player.
//			metodu ucitajVideo kojoj se prosledjuje referenca do videa koji se pusta.
//			Trenutno vreme kada se ucita video se postavlja na nulu. Treba videu da 
//			povecamo broj pregleda!
...
//			metodu postaviKvalitet - metoda kao parametar prima brzinu interneta u 
//			megbajtima.
...
//			metodu aktivirajPrekoCelogEkranaMod -  koja postavlja rezim preko celog 
//			ekrana
//			metodu premotajUnapred - metoda koja premotava trenutno vreme videa za 
//			10s. Vodite racuna da ne predjete duzinu videa.
//			metodu premotajUnazad - metoda vraca trenutno vreme videa za 10s. Vodite 
//			racuna da ne padnete ispod nule
//			iscrtajZvuk - metoda koja ispisuje tekst koji simulira jacinu zvuka. 
//			Svaka crtica predstavlja jecinu od 10.
...
//			Koristicemo zvezdice i tackice. idu 100 zvezdice/tackica. Zvezdice za 
//			ono sto je pogledano.
//			******************************......................................................................
...
//			Objasnjenje v6tuOipj5mk je id videa.
		Video video1 = new Video("a5s5rYpIfH0", "Saban Saulic - Ti me varas najbolje", 252, 20045879);
		YouTubePlayer player = new YouTubePlayer();
		player.ucitajVideo(video1);
		player.pojacaj();
		player.postaviKvalitet(10);
		player.aktivirajPrekoCelogEkrana();
		player.premotajUnapred();
		player.premotajUnapred();
		player.premotajUnapred();
		for (int i = 0; i < 2026300; i++) {
			video1.like();
		}
		for (int i = 0; i < 5; i++) {
			video1.dislike();
		...
		Video video2 = new Video("fK3-kX3rN8c", "Coby - Leto je", 193, 13245784);
		YouTubePlayer player2 = new YouTubePlayer();
		player2.ucitajVideo(video2);
		player2.smanji();
		player2.smanji();
		...
		for (int i = 0; i < 15324; i++) {
			video2.like();
		}
		player2.postaviKvalitet(7);
		player2.aktivirajBioskopskiMod();
		for(int i=0;i<10;i++) {
			player2.premotajUnapred();
		}
		player2.premotajUnazad();
		player2.iscitaj();
		player2.share();
